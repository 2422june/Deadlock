...
public class TrafficManager : ManagerBase
{
    ...
    public void FindRoadButtom()
    {
        ...
        {
            _roadButtons[i] = Manager._find.FindUITransform("Button", parents[i]).GetComponent<RoadButtonController>();
        }
    }
    ...
    public void AddPath(int point)
    {
        ...
        {
            _carPath[0] = point;
            Manager._sound.PlaySE(Define.SE.pee1);
        }
        else if (_carPath[1] == -1)
        {
            ...
            if (_carPath[0] == _carPath[1])
            {
                ...
                {
                    LineStop(point);
                    Manager._sound.PlaySE(Define.SE.pee2);
                }
            }
            else
            {
